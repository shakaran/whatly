...
- **Codecov coverage reporting.** A coverage workflow builds the unit suites instrumented for gcov, runs them headless, and uploads a Cobertura report to Codecov; a badge in the README tracks it. (Coverage reflects the CI-safe logic suites, not the Qt UI or WhatsApp Web.)
